...
{
    public class OV_nonPositiveInteger : ObjectVariants, ILiteralNode, INumLiteral
    {
        public readonly int value;

        public OV_nonPositiveInteger(int value)
        {
            this.value = value;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return value == ((OV_nonPositiveInteger)obj).value;
        ...
        public override int CompareTo(object obj)
        {
            ...
            var otherTyped = (OV_nonPositiveInteger)obj;
