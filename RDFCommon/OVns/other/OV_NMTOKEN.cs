...
{
    public class OV_NMTOKEN : ObjectVariants, ILiteralNode
    {
        public readonly string value;

        public OV_NMTOKEN(string value)
        {
            this.value = value;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return value == ((OV_NMTOKEN)obj).value;
        ...
        {
            return new OV_NMTOKEN(changing(value));
        }
