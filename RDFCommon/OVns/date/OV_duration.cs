...
{
    public class OV_duration : ObjectVariants, ILiteralNode, INumLiteral
    {
        public readonly int value;

        public OV_duration(int value)
        {
            this.value = value;
        }
        ...
        {
            return new OV_duration(changing(value));
        }
        ...
        public override int CompareTo(object obj)
        {
            ...
            var otherTyped = (OV_duration)obj;
