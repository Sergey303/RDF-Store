         ...
         if (this.IsDistinct)
            {
                this.Operator = result =>
                {
                    if (result is SparqlGroupOfResults)
                    {
                        ...
                        return @group.Select(this.Expression.Operator).Distinct().Min(o1 => o1);   
                    }
                ...
                this.TypedOperator = result =>
                {
                    if (result is SparqlGroupOfResults)
                    {
                        ...
                        return firstTyped.Change(o => list.Distinct().Min(o1 => o1));
                    }
                    else throw new Exception();
                };
            }
            else
            {
                this.Operator = result =>
                {
                    if (result is SparqlGroupOfResults)
                    {
                        ...
                        return @group.Select(this.Expression.Operator).Min(o1 => o1);
                    }
                    else throw new Exception();
                };
                this.TypedOperator = result =>
                {
                    if (result is SparqlGroupOfResults)
                    {
                        ...
                        var list = new List<dynamic>() { firstTyped.Content };
                        list.AddRange(@group.Skip(1).Select(this.Expression.Operator));
                        return firstTyped.Change(o => list.Min(o1 => o1));
                    }
                    else throw new Exception();
                };
            }
