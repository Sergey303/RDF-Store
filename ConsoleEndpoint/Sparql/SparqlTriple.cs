     ...
     //   private VariableDataSet variableDataSet;
      ...
      //  public SparqlGraphPatternType PatternType { get { return SparqlGraphPatternType.SparqlTriple; } }
        ...
        //else {
            ...
            return this.ClearNewValues(this.Subject == null, this.Predicate==null, this.Object==null, !this.isGKnown, variableBinding, 
                //this.listOfFilters.Count>0  //? this.SetVariablesValuesWithFilters(variableBinding, (StoreCallCase)@case)  : 
            this.SetVariablesValues(variableBinding, (StoreCallCase)@case));
        ...
        {
            var subject = //this.sVariableNode is IBlankNode ? this.store.NodeGenerator.CreateBlankNode(((IBlankNode)this.sVariableNode).Name+variableBinding.Id):
            ...
            var @object = //this.oVariableNode is IBlankNode ? this.store.NodeGenerator.CreateBlankNode(((IBlankNode)this.oVariableNode).Name+variableBinding.Id) :
        ...
        {
            var subject = //this.sVariableNode is IBlankNode ? this.store.NodeGenerator.CreateBlankNode(((IBlankNode)this.sVariableNode).Name + variableBinding.Id, ((IIriNode)g).UriString) :
                              (this.sVariableNode != null ? variableBinding[this.sVariableNode] : this.Subject);
            var predicate = this.pVariableNode != null ? variableBinding[this.pVariableNode] : this.Predicate;
            var @object = // this.Object ==null && this.oVariableNode is IBlankNode ? this.store.NodeGenerator.CreateBlankNode(((IBlankNode)this.oVariableNode).Name + variableBinding.Id, ((IIriNode)g).UriString):
                          (this.oVariableNode != null ? variableBinding[this.oVariableNode] : this.Object);
